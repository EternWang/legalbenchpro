...
configurations across both splits. The public-exam split is scored by
...
\begin{enumerate}
    ...
    reasoning-enabled modes, and explicit step-by-step prompting setups, enabling
    controlled comparisons within and across model families.
